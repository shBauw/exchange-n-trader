...
int main(int argc, char ** argv) {
    ...
    if (globalFlag == 0) {
        ...
        if (strcmp(buffer, "MARKET BUY GPU 100 100;") != 0) {
            printf("TRADER 2 ERROR\n");
            return 1;
        }
        printf("[T2]\t%s\n", buffer);
    ...
    if (globalFlag == 0) {
        ...
        if (strcmp(buffer, "MARKET SELL Router 100 100;") != 0) {
            printf("TRADER 2 ERROR\n");
            return 1;
        }
        printf("[T2]\t%s\n", buffer);
    ...
    if (globalFlag == 0) {
        ...
        if (strcmp(buffer, "MARKET SELL Router 1 1;") != 0) {
            printf("TRADER 2 ERROR\n");
            return 1;
        }
        printf("[T2]\t%s\n", buffer);
    ...
    if (globalFlag == 0) {
        ...
        if (strcmp(buffer, "MARKET SELL Router 0 0;") != 0) {
            printf("TRADER 2 ERROR\n");
            return 1;
        }
        char string[200] = "SELL 0 GPU 100 100;";
